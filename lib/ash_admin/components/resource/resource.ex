defmodule AshAdmin.Components.Resource do
  ...
  import AshAdmin.CoreComponents, only: [single_column_layout: 1]
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.single_column_layout>
        ...
        <div
          :if={@record == nil && @action && @action_type == :read && !@action.pagination}
          class="flex items-center justify-center h-64"
        >
          <p class="font-bold tracking-wide">No record found for action "{@action.name}".</p>
        </div>
